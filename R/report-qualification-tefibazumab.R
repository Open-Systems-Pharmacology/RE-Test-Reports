#' @title report-qualification-tefibazumab
#' @description
#' Qualification Report for `Open-Systems-Pharmacology/Tefibazumab-Model` repository
...
qualificationProject <- "Tefibazumab-Model"
snapshotFile <- "Tefibazumab.json"
...
download.file("https://github.com/Open-Systems-Pharmacology/Tefibazumab-Model/archive/refs/heads/master.zip", destfile = "archive.zip")
unzip("archive.zip", exdir = "archive")
unlink("archive.zip")
dir.create(workingDirectory)
file.copy("archive/Tefibazumab-Model-master/Evaluation/Input", workingDirectory, recursive = TRUE)
# In this repo, the snapshot is outside the evaluation folder and its path needs to be updated
file.copy(file.path("archive/Tefibazumab-Model-master/", snapshotFile), workingDirectory, recursive = TRUE)
