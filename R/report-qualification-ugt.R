#' @title report-qualification-ugt
#' @description
...
download.file("https://github.com/Open-Systems-Pharmacology/Pediatric_Qualification_Package_UGT1A1_Ontogeny/archive/refs/heads/main.zip", destfile = "archive.zip")
unzip("archive.zip", exdir = "archive")
unlink("archive.zip")
dir.create(workingDirectory)
file.copy("archive/Pediatric_Qualification_Package_UGT1A1_Ontogeny-main/Qualification/Input", workingDirectory, recursive = TRUE)
