#' @title report-qualification-cda1
#' @description
#' Qualification Report for `Open-Systems-Pharmacology/CDA1-Model` repository
...
qualificationProject <- "CDA1-Model"
snapshotFile <- "CDA1.json"
...
download.file("https://github.com/Open-Systems-Pharmacology/CDA1-Model/archive/refs/heads/master.zip", destfile = "archive.zip")
unzip("archive.zip", exdir = "archive")
unlink("archive.zip")
dir.create(workingDirectory)
file.copy("archive/CDA1-Model-master/Evaluation/Input", workingDirectory, recursive = TRUE)
# In this repo, the snapshot is outside the evaluation folder and its path needs to be updated
file.copy(file.path("archive/CDA1-Model-master/", snapshotFile), workingDirectory, recursive = TRUE)
