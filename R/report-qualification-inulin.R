#' @title report-qualification-inulin
#' @description
...
qualificationProject <- "Inulin-Model"
snapshotFile <- "Inulin.json"
...
download.file("https://github.com/Open-Systems-Pharmacology/Inulin-Model/archive/refs/heads/master.zip", destfile = "archive.zip")
unzip("archive.zip", exdir = "archive")
unlink("archive.zip")
dir.create(workingDirectory)
file.copy("archive/Inulin-Model-master/Evaluation/Input", workingDirectory, recursive = TRUE)
# In this repo, the snapshot is outside the evaluation folder and its path needs to be updated
file.copy(file.path("archive/Inulin-Model-master/", snapshotFile), workingDirectory, recursive = TRUE)
