#' @title report-qualification-digoxin
#' @description
#' Qualification Report for `Open-Systems-Pharmacology/Digoxin-Model` repository
...
file.copy("archive/Digoxin-Model-master/Evaluation/Input", workingDirectory, recursive = TRUE)
# In this repo, the snapshot is outside the evaluation folder and its path needs to be updated
file.copy(file.path("archive/Digoxin-Model-master/", snapshotFile), workingDirectory, recursive = TRUE)
