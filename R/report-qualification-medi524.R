#' @title report-qualification-medi524
#' @description
#' Qualification Report for `Open-Systems-Pharmacology/MEDI524-Model` repository
...
qualificationProject <- "MEDI524-Model"
snapshotFile <- "MEDI524.json"
...
download.file("https://github.com/Open-Systems-Pharmacology/MEDI524-Model/archive/refs/heads/master.zip", destfile = "archive.zip")
unzip("archive.zip", exdir = "archive")
unlink("archive.zip")
dir.create(workingDirectory)
file.copy("archive/MEDI524-Model-master/Evaluation/Input", workingDirectory, recursive = TRUE)
# In this repo, the snapshot is outside the evaluation folder and its path needs to be updated
file.copy(file.path("archive/MEDI524-Model-master/", snapshotFile), workingDirectory, recursive = TRUE)
