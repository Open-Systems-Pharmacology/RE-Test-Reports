...
unlink('ospsuite.zip')
download.file('https://ci.appveyor.com/api/projects/open-systems-pharmacology-ci/ospsuite-reportingengine/artifacts/ospsuite.reportingengine_2.2.296.zip', destfile = 'ospsuite.reportingengine.zip', mode='wb')
