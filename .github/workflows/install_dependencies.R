...
unlink('ospsuite.zip')
download.file('https://ci.appveyor.com/project/open-systems-pharmacology-ci/OSPSuite-ReportingEngine/artifacts/ospsuite.reportingengine_2.2.296.zip', destfile = 'ospsuite.reportingengine.zip', mode='wb')
