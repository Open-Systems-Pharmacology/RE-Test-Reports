...
unlink('ospsuite.zip')
download.file('https://ci.appveyor.com/api/projects/open-systems-pharmacology-ci/ospsuite.reportingengine/artifacts/ospsuite.reportingengine.zip?pr=false', destfile = 'ospsuite.zip', mode='wb')
